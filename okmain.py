...
class SignalDetector:
    ...
    def __init__(self):
        ...
        self.AUTO_CLOSE_THRESHOLD_LOSS = -4.6  # USD
    ...
    def _monitor_trailing_stop(self, binance_order_id: str):
        ...
        while not self.shutdown_event.is_set():
            try:
                ...
                if is_manual:
                    min_target_profit = 2.6  # Target profit minimal untuk order manual
                    trailing_distance = 0.6  # Jarak trailing untuk order manual
                else:
